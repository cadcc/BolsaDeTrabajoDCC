...
urlpatterns = [
    ...
    url(r'^preguntas-frecuentes$', common.faq, name='faq'),
    url(r'^terminos-de-uso$', common.terms, name='terms'),
    ...
    url(r'^empresa$', company.mi_empresa, name='mi_empresa'),
    url(r'^empresa/(?P<id_empresa>(\d{1,}))$', company.empresa, name='empresa'),
    ...
    url(r'^imagen-empresa$', view=company.change_picture, name='imagen_empresa'),
    ...
    url(r'^aprobar-usuarios/$', view=admin.review_users, name='aprobar_usuarios'),
    url(r'^aprobar-usuarios/aceptar$', view=admin.accept_user, name="aceptar_usuario"),
    url(r'^aprobar-usuarios/rechazar$', view=admin.reject_user, name="rechazar_usuario"),
    url(r'^aprobar-usuarios/download/(?P<user_id>(\d{1,}))$', view=admin.download_file, name="descargar_archivo"),
